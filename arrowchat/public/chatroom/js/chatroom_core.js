	...
	a.arrowchat = function () {
		...
		function addMessageToChatroom(b, c, d) {
			...
			if (a("#arrowchat_chatroom_message_" + b).length > 0) {
				...
				a(".arrowchat_popout_convo").append('<div class="arrowchat_chatroom_box_message arrowchat_self' + important + '" id="arrowchat_chatroom_message_' + b + '"><img class="arrowchat_chatroom_message_avatar" src="'+u_avatar+'" alt="' + c + title + '" /><div class="arrowchat_chatroom_message_name">' + c + title + ':</div><div class="arrowchat_chatroom_message_content"><div class="arrowchat_chatroom_delete" data-id="' +  b + '"> </div>' + formatTimestamp(new Date(Math.floor((new Date).getTime() / 1E3) * 1E3)) + '<span class="arrowchat_chatroom_msg">' + d + "</span></div></div>");
