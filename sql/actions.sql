...
('comment_publish_action','comment','comment_publish_action','{\"icon\":\"fa fa-cog\"}','%title% Publico un comentario'),('comment_save_action','comment','comment_save_action','{\"icon\":\"fa fa-cog\",\"vars\":[]}','%title% Save comment'),('comment_unpublish_action','comment','comment_unpublish_action','','Unpublish comment'),
('docente_write_calificacion','docente','docente_write_calificacion','{\r\n    \"icon\": \"fa flaticon-a1\",\r\n    \"vars\": [\r\n        \"estudiante\",\r\n        \"parcial\",\r\n        \"quimestre\"\r\n    ]\r\n}','Ha pasado la nota al estudiante %estudiante% en la materia %materia% correspondiente al %tn% %parcial% del %quimestre%'),
('docente_write_calificacion_you','estudiante','docente_write_calificacion_you','{\r\n    \"icon\": \"fa flaticon-a1\",\r\n    \"vars\": [\r\n        \"docente\",\r\n	\"materia\",\r\n        \"nota\"\r\n    ]\r\n}','El docente %docente% ha pasado tu calificacion de %materia%'),
