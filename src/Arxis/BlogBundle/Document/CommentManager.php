...
namespace Arxis\BlogBundle\Document;

use Sonata\CoreBundle\Model\BaseDocumentManager;
use Sonata\DoctrineMongoDBAdminBundle\Datagrid\Pager;
use Sonata\DoctrineMongoDBAdminBundle\Datagrid\ProxyQuery;
use Arxis\BlogBundle\Model\CommentInterface;
use Arxis\BlogBundle\Model\CommentManagerInterface;
use Arxis\BlogBundle\Model\PostInterface;
...
class CommentManager extends BaseDocumentManager implements CommentManagerInterface
{
     ...
     *
     * @param \Arxis\BlogBundle\Model\PostInterface $post
     */
