...
class CalificarComportamientoType extends AbstractType
{
    private $quimestre;
    private $parcial;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('calificaciones', CollectionType::class, array(
                        ...
                        'entry_type' => ComportamientoType::class ,
                        'entry_options'  => array(
                            //'required'  => false,
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'MultiacademicoBundle\Calificar\ComportamientoACalificar',
    ...
    {
        return 'calificar_comportamiento';
    }
}
