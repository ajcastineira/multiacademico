  ...
  var $Neg = "Menos";
    ...
    public function ValorEnLetras($x, $Moneda="" )
    {
        ...
        if($Frc != $this->Void)
        {
           ...
           $s = $s . " coma " . $this->SubValLetra($Frc) . "";
           //$s = $s . " " . $Frc . "/100";
        }
        $valorenletras=$Signo . $s . " ";
        $valorenletras=str_replace("y Cero", "", $valorenletras);
    ...
    public static function convierteEnLetras($num)
    {
        $numtoletra=new NumToLetras();
        return $numtoletra->ValorEnLetras($num);
    }
