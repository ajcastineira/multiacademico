...
use Multiservices\ArxisBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MultiservicesArxisBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("MultiservicesArxisBundle:Role:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MultiservicesArxisBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MultiservicesArxisBundle:Role:edit.html.twig")
     */
