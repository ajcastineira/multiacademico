...
class MensajesControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $this->assertEquals(200, $client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /mensajes/");
        $crawler = $client->click($crawler->selectLink('Crear nuevo registro')->link());

        // Fill in the form and submit it
        $form = $crawler->selectButton('Create')->form(array(
            'multiservices_arxisbundle_mensajestype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Editar')->form(array(
            'multiservices_arxisbundle_mensajestype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
