...
class DefaultController extends Controller
{
    ...
    {
        return $this->render('PcimagencaChatBundle:Default:indexx.html.twig', array('name' => $name));
    }
}
...
/**
     * @return Response
     *
     * @Route("/{channel}", name="pcimagenca_chat", defaults={"channel" = "default"})
     * @Template
     */
     public function indexAction()
    {
        
        return $this->render('PcimagencaChatBundle:Default:index.html.twig');
    }
    /**
     * @return Response
     *
